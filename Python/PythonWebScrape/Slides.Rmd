...
(For this workshop you will need the Python 3 version.)

Accepting the defaults proposed by the Anaconda installer is generally
recommended.

Launch Jupyter Notebook and start a new notebook.

Find notes at [dss.iq.harvard.edu](https://dss.iq.harvard.edu)
...
## You can sometimes access the data directly
...
## Making our first request in python
...
## Selecting more elements using xpath
...
## Identifying the elements we want
...
## Iterating over interesting elements
