...
Everyone: 
- Open a web browser and download class materials from [[http://tutorials.iq.harvard.edu/Stata/StataGraphics.zip]].
- Extract the downloaded zip file and move the =StataGraphics= folder to your Desktop.
- Start the Stata program and open the =StataGraphics.do= file.
