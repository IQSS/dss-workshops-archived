...
* (add-to-list 'ess-STA-mode-font-lock-defaults '(("^[*].*$") . ((1 font-lock-comment-face))))
...
*   - Remember, if you run these commands without specifying variables, 
*     Stata will produce output for every variable 

* 3.2 Basic graphing commands 
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
* 3.4 Exercise 2: Descriptive statistics 
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
* 4.6 Recoding, dropping variables 
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
* 4.7 Exercise 4: Manipulating variables 
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
