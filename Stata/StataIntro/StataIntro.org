...
Lab computer users: log in using the user name and password on the board to your right.
...
#+name: commentSyntax
#+begin_src stata :exports code :eval no
...
#+RESULTS: commonDescriptiveCommands
#+begin_example
use gss.dta, clear
...
4. Summarize the variable, "income" separately for each level of marital status
