...
http://tutorials.iq.harvard.edu/R/RDataWrangling/RDataWrangling.html
...
individual years; it has the disadvantage of making it more difficult
to examine questions that require data from multiple years. To make the
...
Exercise 4 solution: Make one big table
------------------
