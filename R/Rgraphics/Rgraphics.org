...
#+begin_src R :exports code
                                          #Ex2.1
  (p <- ggplot(housing, aes(x = factor(gear), y = mpg)) + geom_boxplot())
                                          #Ex2.2
  p + geom_point()
                                          #Ex2.3
  (p <- ggplot(housing, aes(x = wt, y = hp)) + geom_point())
                                          #Ex2.4
