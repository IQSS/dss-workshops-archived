...
#+begin_src R :results silent :exports none :tangle no
  ...
  .First <- function() {
    ...
    require(plyr)
    theme_set(theme_bw())
    png <<- function(res=96, width=700, height=300, ...) grDevices::png(res=res, width=width, height=height, ...)
  }
#+end_src
...
#+name: ggplotHist1
#+begin_src R :results graphics :width 700 :file images/ggplotHist1.png 
  library(ggplot2)
...
#+name: ggplotComplex1
#+begin_src R :results graphics :width 700 :file images/ggplotComplex1.png
...
#+begin_src R :results output graphics :width 700 :file images/firstScatter.png 
...
#+begin_src R :results output graphics :width 700 :file images/firstScatterLog.png 
  ggplot(hp2001Q1,
...
#+name: multipleLayers
#+begin_src R :results output graphics :width 700 :file images/housingLayers.png 
...
#+begin_src R :results output graphics :width 700 :file images/housingLayers2.png 
  p1 +
...
#+begin_src R :results output graphics :width 700 :file images/textGeomMapping.png 
  p1 + 
...
#+begin_src R :results output graphics :width 700 :file images/textGeomMapping2.png
...
#+name: housingMapping
#+begin_src R :results output graphics :width 700 :file images/housing2.png 
  p1 +
...
#+begin_src R :results output graphics :width 700 :file images/addColorAndShapeMapping.png 
  p1 +
...
#+begin_src R :results output graphics :width 700 :file images/GeomBinDefaults.png 
...
#+begin_src R :results output graphics :width 700 :file images/ChangeStatBinArgs.png 
...
#+name: BarPlotSum1
#+begin_src R :results output graphics :width 700 :file images/ChangeStat.png
  ggplot(housing.sum, aes(x=State, y=Home.Value)) + 
...
#+name: housingscatter
#+begin_src R :results output graphics :width 700 :file images/housing1.png 
...
*** Wrong
#+name: WrongWayNoMelt
#+begin_src R :results output graphics :width 700 :file images/WrongWayNoMelt.png 
...
*** Right
#+name: meltingDataExe
#+begin_src R :results output graphics :width 700 :file images/meltingDataExe.png 
  library(tidyr)
...
#+name: econDatScatter
#+begin_src R :results output graphics :width 700 :file images/econScatter1.png 
  dat <- read.csv("dataSets/EconomistData.csv")
...
#+begin_src R :results output graphics :width 700 :file images/econScatter2.png 
  pc2 <- pc1 +
...
#+BEGIN_SRC R :results output graphics :width 700 :file images/shapes.png
...
#+begin_src R :results output graphics :width 700 :file images/econScatter3.png 
  pc2 +
...
#+begin_src R :results output graphics :width 700 :file images/econScatter3b.png 
