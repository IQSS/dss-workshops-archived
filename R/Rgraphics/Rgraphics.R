...
#  `dataSets/EconomistData.csv' file. Read it in with `dat <-
#  read.csv("dataSets/EconomistData.csv")' Original sources for these
#  data are [http://www.transparency.org/content/download/64476/1031428]
