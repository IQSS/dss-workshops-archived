...
[12] <a onclick="_gaq.push(['_trackEvent', 'File','Download', 'cepr ...
[13] <a onclick="_gaq.push(['_trackEvent', 'File','Download', 'cepr ...
[14] <a onclick="_gaq.push(['_trackEvent', 'File','Download', 'cepr ...
[15] <a onclick="_gaq.push(['_trackEvent', 'File','Download', 'cepr ...
> 
> ## extract the link ("href") attributes
> allLinks <- html_attr(allAnchors, "href")
> head(allLinks, 15)
...
For now, lets start by downloading just the data files for years since 2000.
...
> ## deviation from the average
> apply(ceprFileInfo, MARGIN = 1, function(x) x - fileInfoAverage) # 
     cepr_dws_2000_dta.zip cepr_dws_2002_dta.zip
size             -653403.5              221540.5
mode                   0.0                   0.0
     cepr_dws_2004_dta.zip cepr_dws_2006_dta.zip
size              157554.5               95906.5
mode                   0.0                   0.0
     cepr_dws_2008_dta.zip cepr_dws_2010_dta.zip
size               19403.5              158998.5
mode                   0.0                   0.0
> 
#+end_example
...
> sapply(ceprData, object.size)
cepr_dws_2000.dta cepr_dws_2002.dta cepr_dws_2004.dta 
        113418392         139094688         137007848 
cepr_dws_2006.dta cepr_dws_2008.dta cepr_dws_2010.dta 
        135336704         135192464         135916432 
> 
#+end_example
...
> attributes(ceprData)
$names
[1] "cepr_dws_2000.dta" "cepr_dws_2002.dta" "cepr_dws_2004.dta"
[4] "cepr_dws_2006.dta" "cepr_dws_2008.dta" "cepr_dws_2010.dta"
...
> ceprCodebook <- data.frame(ceprDataInfo[ sapply(ceprDataInfo, length) == ncol(ceprData[[1]]) ])
> rbind(head(ceprCodebook), tail(ceprCodebook))
       names formats types val.labels
1       year   %8.0g   252           
2      indws   %8.0g   251           
3    dw_stat   %8.0g   251           
4     dwswgt   %9.0g   254           
5         dw   %8.0g   251           
6     dw_bls   %8.0g   251           
173 peernhro   %8.0g   251           
174   imphrs   %9.0g   254           
175 hrsimptd   %9.0g   251           
176  hrernhr   %8.0g   251           
177  uhoursi   %9.0g   251           
178  blsimpt   %8.0g   251           
                          var.labels
1                               Year
2                   Eligible for DWS
3               DWS interview status
4                         DWS weight
5                          Displaced
6   Displaced, strict BLS definition
173           Usual hours, ORG (BLS)
174        Hours, main job (imputed)
175                    Hours imputed
176           Hours assigned, ernhro
177             Hours, w/ imputation
178       BLS allocated weekly hours
> 
#+end_example
...
#+begin_example
> ls() # list objects in our workspace
 [1] "allAnchors"      "allLinks"        "ceprCodebook"   
 [4] "ceprData"        "ceprDataFiles"   "ceprDataInfo"   
 [7] "ceprFileInfo"    "ceprFiles"       "ceprInfoLength" 
[10] "char.var"        "char.var2"       "dataLinks"      
[13] "dataPage"        "disp"            "disp.matrix"    
[16] "downloadFiles"   "file"            "fileInfoAverage"
[19] "fsizes"          "infoInfo"        "link"           
[22] "log.var"         "mean.foo"        "num.var"        
[25] "num.var2"        "x"              
> length(char.var) # how many elements in char.var?
[1] 4
> str(num.var2) # what is the structure of num.var2?
