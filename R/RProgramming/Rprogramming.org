...
Our first task is to read the web page into R. We can do that using the =read_html= function. Next we want to find all the links (the =<a>= tags) and extract their =href= attributes. To give a better sense of this here is what the html for the 2014 data file link looks like:
#+BEGIN_SRC HTML
  <a onclick="_gaq.push(['_trackEvent', 'File','Download', 'cepr_org_2011']);"
     href="/wp-content/cps/data/cepr_org_2014.zip">cepr_org_2014.zip</a>
#+END_SRC 
We want the =href= part, i.e., "/wp-content/cps/data/cepr_org_2014.zip".
...
#+BEGIN_SRC R
  ...
  dataPage <- read_html("http://ceprdata.org/cps-uniform-data-extracts/cps-outgoing-rotation-group/cps-org-data/")
...
{xml_nodeset (15)}
 ...
 [5] <a href="http://ceprdata.org/sipp-uniform-data-extracts/">SIPP ...
...
[10] <a href="https://org.salsalabs.com/o/967/p/salsa/donation/comm ...
[11] <a rel="bookmark" href="http://ceprdata.org/cps-uniform-data-e ...
[12] <a title="CPS ORG Programs" href="http://ceprdata.org/wp-conte ...
[13] <a onclick="_gaq.push(['_trackEvent', 'File','Download', 'cepr ...
[14] <a href="/wp-content/cps/data/cepr_org_2013.zip">cepr_org_2013 ...
[15] <a href="/wp-content/cps/data/cepr_org_2012.zip">cepr_org_2012 ...
> 
> ## extract the link ("href") attributes
> allLinks <- html_attr(allAnchors, "href")
> head(allLinks, 15)
...
[11] "http://ceprdata.org/cps-uniform-data-extracts/cps-outgoing-rotation-group/cps-org-data/"
[12] "http://ceprdata.org/wp-content/cps/programs/org/cepr_org_master.do"                     
[13] "/wp-content/cps/data/cepr_org_2014.zip"                                                 
[14] "/wp-content/cps/data/cepr_org_2013.zip"                                                 
[15] "/wp-content/cps/data/cepr_org_2012.zip"                                                 
> 
#+end_example
...
One answer is to use regular expressions to idenfify the links we want. Regular expressions are useful in general (not just in R!) and it is a good idea to be familiar with at least the basics. If you have not been introduced to regular expressions yet a nice interactive regex tester is available at [[http://www.regexr.com/]] and an interactive tutorial is available at [[http://www.regexone.com/]]. For our present purpose it will be more than enough to use regular expression that matches strings starting with =/wp= and ending with =.zip=. We can use the =grep= function to match the URLs we want, and exclude those we don't want.
#+BEGIN_SRC R
