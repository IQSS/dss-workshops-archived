...
** TODO Just the data please -- regular expressions to the rescue
...
Finally, the data links we've extracted are relative to the ceprdata website. To make them valid we need to prepend =http://ceprdata.org/= to each one. We can do that using the =paste= function.
#+BEGIN_SRC R
...
#+begin_example
      link                                                            base
 [1,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_1994_dta.zip" "cepr_dws_1994_dta.zip"
 [2,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_1996_dta.zip" "cepr_dws_1996_dta.zip"
 [3,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_1998_dta.zip" "cepr_dws_1998_dta.zip"
 [4,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_2000_dta.zip" "cepr_dws_2000_dta.zip"
 [5,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_2002_dta.zip" "cepr_dws_2002_dta.zip"
 [6,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_2004_dta.zip" "cepr_dws_2004_dta.zip"
 [7,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_2006_dta.zip" "cepr_dws_2006_dta.zip"
 [8,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_2008_dta.zip" "cepr_dws_2008_dta.zip"
 [9,] "http://ceprdata.org/wp-content/cps/data/cepr_dws_2010_dta.zip" "cepr_dws_2010_dta.zip"
#+end_example
...
** Iterating with the =apply= family of functions
The /apply famiy/ of functions in R that are useful for iteration. The apply family of functions includes:
...
#+BEGIN_SRC R :results silent
  ...
  names(fsizes) <- ceprFiles
  for (file in ceprFiles) {
...
#+begin_example
                         size mode
cepr_dws_1994_dta.zip 4973180  420
cepr_dws_1996_dta.zip 4361662  420
cepr_dws_1998_dta.zip 4363591  420
...
#+end_example
ceprFileInfo is a _matrix_, with each row containing information about one of the files we downloaded. We can calculate the means for each column in this mattrix using the =apply= function:
...
#+RESULTS:
#+begin_example
cepr_dws_1994_dta.zip cepr_dws_1996_dta.zip cepr_dws_1998_dta.zip cepr_dws_2000_dta.zip
"./cepr_dws_1994.dta" "./cepr_dws_1996.dta" "./cepr_dws_1998.dta" "./cepr_dws_2000.dta"
cepr_dws_2002_dta.zip cepr_dws_2004_dta.zip cepr_dws_2006_dta.zip cepr_dws_2008_dta.zip
"./cepr_dws_2002.dta" "./cepr_dws_2004.dta" "./cepr_dws_2006.dta" "./cepr_dws_2008.dta"
cepr_dws_2010_dta.zip
"./cepr_dws_2010.dta"
#+end_example
...
cepr_dws_1994.dta cepr_dws_1996.dta cepr_dws_1998.dta cepr_dws_2000.dta cepr_dws_2002.dta
        129893032         111614672         112460056         113418392         139094688
cepr_dws_2004.dta cepr_dws_2006.dta cepr_dws_2008.dta cepr_dws_2010.dta
        137007848         135336704         135192464         135916432
#+end_example
