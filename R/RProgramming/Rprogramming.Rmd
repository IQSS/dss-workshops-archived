...
to <example_data/baby_names/>. Although we could
...
```
6.  Use the `str_c` function to prepend `baby.names.path` to
...
## 5. construct URLs
(girl.file.names <- str_c(baby.names.path, girl.file.names, sep = "/"))
(boy.file.names <- str_c(baby.names.path, boy.file.names, sep = "/"))
```
