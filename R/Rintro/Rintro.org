...
>   ## examine our newly created variables
> head(subset(datGSS,
+             select = c("age", "ageC", "wifeduc", "wifeduc_complete",
+                        "husbeduc", "educ.diff")), n = 8)
  age       ageC wifeduc wifeduc_complete husbeduc educ.diff
1  69  22.363636      NA               NA       NA        NA
2  27 -19.636364      13               13       10         3
3  19 -27.636364      NA               NA       NA        NA
4  21 -25.636364      NA               NA       NA        NA
5  19 -27.636364      NA               NA       NA        NA
6  87  40.363636      NA               NA       NA        NA
7  42  -4.636364      10               10       11        -1
8  19 -27.636364      NA               NA       NA        NA
> 
> 
#+end_example
...
3) [@3] Make sure that the data loaded in step 2 is a data.frame (hint: check the arguments documented in the help page)
#+BEGIN_SRC R
  class(gss.data)
#+END_SRC
...
> with(datGSS, table(emailhrs, sex))
                    sex
emailhrs             Male Female
  -3                   13     18
  -2                    1      2
  -1                  303    431
  0                    29     39
  0.0166666666666667    1      0
  0.0333333333333333    0      1
  0.0833333333333333   11      4
  0.166666666666667    11      5
  0.25                  6      7
  0.266666666666667     1      0
  0.333333333333333     5     10
  0.5                  26     16
  0.583333333333333     2      0
...
#+BEGIN_SRC R :results output graphics :file ex3.png :height 300
...
#+BEGIN_SRC R :results output graphics :file ex3_1.png :height 300
