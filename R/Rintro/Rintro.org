...
** License
[[http://creativecommons.org/licenses/by-sa/4.0/][file:https://i.creativecommons.org/l/by-sa/4.0/88x31.png]] These IQSS Statistical Software Workshop materials are licensed by [[http://rtc.iq.harvard.edu][Harvard University]] under a [[http://creativecommons.org/licenses/by-sa/4.0/][Creative Commons Attribution-ShareAlike 4.0 International License]].
...
You can extract subsets of data.frames using the =subset()= function[fn:1]. Use the =select= argument to select columns:
